...
function Experience() {
  return (
    <div className="max-w-5xl mx-auto mt-10 dark:bg-gray-900" id="experiencia">
      ...
      <section className="flex flex-col md:flex-row items-center rounded-lg shadow-lg p-8 mb-8">
        <div className="w-full md:w-1/4 flex justify-center md:justify-start mb-6 md:mb-0">
          <img
            ...
            className="w-32 h-32 md:w-40 md:h-40 object-contain border-4 border-gray-200 shadow-md bg-white rounded-full transition-transform duration-300 hover:scale-110"
          />
        </div>
        <div className="w-full md:w-3/4 flex flex-col justify-center md:pl-10">
          <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-200 mb-2">Beta Procesos SA de CV</h3>
      ...
      <section className="flex flex-col md:flex-row items-center  rounded-lg shadow-lg p-8 mb-8">
        ...
        <div className="w-full md:w-3/4 flex flex-col justify-center md:pl-10">
          <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-200 mb-2">Innova Business Technology</h3>
